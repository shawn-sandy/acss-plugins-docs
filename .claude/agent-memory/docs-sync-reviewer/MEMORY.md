...
- **verified-at:** `2026-06-05T00:00:00Z`
...
- Full discovery run performed at `9a1da00`: found `plugins/acss-kit` and `plugins/style-agent`; `plugins/acss-utilities` absent (removed upstream).
