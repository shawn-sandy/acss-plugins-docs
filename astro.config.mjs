          ...
          items: [
            { label: 'Overview', slug: 'acss-kit/overview' },
            {
              ...
              items: [
                ...
                { label: '/kit-add-html', slug: 'acss-kit/commands/kit-add-html' },
                ...
                { label: '/prompt-book', slug: 'acss-kit/commands/prompt-book' },
              ],
            },
            {
              label: 'Skills',
              items: [
                ...
                { label: 'components-html skill', slug: 'acss-kit/skills/components-html' },
                ...
                { label: 'prompt-book skill', slug: 'acss-kit/skills/prompt-book' },
