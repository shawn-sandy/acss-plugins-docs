...
| Version | Changes                                                                                                                                                     |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.5.1   | Added getting-started tutorial (`docs/tutorial.md`) — a guided walkthrough chaining all three skills in composition order                                   |
| 0.5.0   | Added COMPONENT.md spec — a framework-neutral format for describing components, themed by a sibling DESIGN.md. Docs-only.                                   |
| 0.4.0   | `/inline-style-to-class` adds IDE selection support — in-place editing from VS Code / JetBrains selection; tokenizes all hard-coded values to CSS variables |
