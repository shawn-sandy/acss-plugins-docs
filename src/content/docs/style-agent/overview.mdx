...
| Version | Changes                                                                                                     |
| ------- | ----------------------------------------------------------------------------------------------------------- |
| 0.5.1   | Added getting-started tutorial (`docs/tutorial.md`) — walks through all three commands in composition order |
| 0.5.0   | Added COMPONENT.md spec — framework-neutral component format shipped with spec, example, and advisory rule  |
