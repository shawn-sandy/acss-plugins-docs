...
New to style-agent? The [Getting Started tutorial](/acss-plugins-docs/style-agent/getting-started) walks through all three commands in composition order — generate a class string from intent, consolidate it into a named class, and migrate existing inline styles — using a single real example.

## Version history

| Version | Changes                                                                                           |
| ------- | ------------------------------------------------------------------------------------------------- |
| 0.5.1   | Added getting-started tutorial (`docs/tutorial.md`) — guides chaining all three commands in order |
| 0.5.0   | Added COMPONENT.md spec — framework-neutral component format paired with DESIGN.md tokens         |
