...
plugins/acss-kit/
  ...
  skills/
    ...
    component-<name>/          # 15 per-component skills (alert, button, card, …)
      ...
      <name>.component.md      # Framework-neutral spec (source of truth as of v1.9+); preferred over reference.md
      reference.md             # Legacy canonical template (byte-identical fallback; kept for backwards compat)
    styles/
