...
description: Consumer guide for the acss-kit Input component — text-based form control with first-class validation states, error/hint aria-describedby wiring, and accessible-disabled pattern.
---
...
<ComponentPreview
  code={`<div style="display:flex;flex-direction:column;gap:1rem;max-width:22rem;padding:1rem;">
  <div style="display:flex;flex-direction:column;gap:0.375rem;">
    <label for="email-ex" style="font-size:0.875rem;font-weight:600;">Email address</label>
    <input id="email-ex" type="email" placeholder="you@example.com" style="padding:0.5rem 0.75rem;border:1px solid var(--color-border,#d4d4d8);border-radius:0.375rem;font-size:0.9375rem;width:100%;box-sizing:border-box;" />
  </div>
  <div style="display:flex;flex-direction:column;gap:0.375rem;">
    <label for="error-ex" style="font-size:0.875rem;font-weight:600;">Email address</label>
    <input id="error-ex" type="email" value="bad-email" aria-invalid="true" style="padding:0.5rem 0.75rem;border:1px solid var(--color-danger,#c2410c);border-radius:0.375rem;font-size:0.9375rem;width:100%;box-sizing:border-box;" />
    <p id="error-ex-error" style="font-size:0.8125rem;color:var(--color-danger,#c2410c);margin:0;">Please enter a valid email address.</p>
  </div>
</div>`}
  label="Input states preview — default and invalid"
/>
...
2. **Add this component:** `/kit-add Input` — copies `input.tsx` + `input.scss` into your components directory (default `src/components/fpkit/`). Add `Field` too (or run `/kit-sync`) for label association. Or run `/kit-sync` to install all components at once.
...
- [`component-input` skill](/acss-plugins-docs/acss-kit/skills/component-input) — maintainer reference (generation contract)
