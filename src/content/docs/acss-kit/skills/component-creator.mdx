...
The `component-creator` skill powered [`/kit-create`](/acss-plugins-docs/acss-kit/commands/kit-create). It also auto-triggered on natural-language phrases. `/kit-create` Creator Mode now lives in the `kit-core` skill.

<Aside type="note">
  The `component-creator` pilot skill was first absorbed into the `components`
  skill in acss-kit v1.0.0, then moved again to `skills/kit-core/SKILL.md` in
  v1.2.0 when components were split into per-component skills. **Creator Mode**
  now lives in the `## Creator Mode` section of `skills/kit-core/SKILL.md`. This
...
| **Dependencies** | Per-component skills at `plugins/acss-kit/skills/component-<name>/`                                              |
| **Status**       | Creator Mode now lives in `skills/kit-core/SKILL.md` (since v1.2.0)                                              |

## Supported components

Per-component skills live under `plugins/acss-kit/skills/component-<name>/`:
