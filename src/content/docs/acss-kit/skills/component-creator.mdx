---
title: component-creator skill (absorbed)
description: Generates a single component instance from a natural-language description — now built into the components skill as Creator Mode (acss-kit v1.0.0).
---
...
<Aside type="caution">
  **This skill was absorbed into the `components` skill as of acss-kit v1.0.0.**
  The `component-creator` skill directory no longer exists upstream. Creator
  Mode is now the `## Creator Mode` section of the [`components`
  skill](/acss-plugins-docs/acss-kit/skills/components). This page is preserved
