...
| **Status**       | Pilot — supports any acss-kit component with a dedicated reference doc under `references/components/<name>.md`; components without a dedicated doc (Badge, Tag, Heading, Text, Details, Progress) are not yet supported |
