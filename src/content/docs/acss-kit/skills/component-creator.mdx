...
The `component-creator` skill powered [`/kit-create`](/acss-plugins-docs/acss-kit/commands/kit-create). It also auto-triggered on natural-language phrases. `/kit-create` is now handled by the [`kit-core` skill](/acss-plugins-docs/acss-kit/skills/kit-core) (Creator Mode).

<Aside type="note">
  The `component-creator` pilot skill was absorbed into the `components` skill
  in acss-kit v1.0.0, and the `components` skill was then **renamed to
  `kit-core`** in acss-kit v1.2.0. **Creator Mode** now lives in the `##
  Creator Mode` section of `skills/kit-core/SKILL.md`. Per-component reference
  docs also moved — they now live in `skills/component-<name>/reference.md`
  (one file per component). This page is preserved for reference.
</Aside>
...
| **Dependencies** | Per-component reference docs at `plugins/acss-kit/skills/component-<name>/reference.md` (as of v1.2.0)           |
| **Status**       | Absorbed into `components` skill v1.0.0; `components` renamed to `kit-core` v1.2.0                               |

## Supported components

As of v1.2.0, reference docs live at `plugins/acss-kit/skills/component-<name>/reference.md` (previously under `skills/components/references/components/`):

| Component              | Reference doc path (v1.2.0+)                                                                      |
| ---------------------- | ------------------------------------------------------------------------------------------------- |
| Button, IconButton     | `component-button/reference.md`, `component-icon-button/reference.md`                             |
| Alert                  | `component-alert/reference.md`                                                                    |
| Card, Dialog, Popover  | `component-card/reference.md`, `component-dialog/reference.md`, `component-popover/reference.md`  |
| Link, Img, Icon        | `component-link/reference.md`, `component-img/reference.md`, `component-icon/reference.md`        |
| Input, Checkbox, Field | `component-input/reference.md`, `component-checkbox/reference.md`, `component-field/reference.md` |
| List, Table, Nav       | `component-list/reference.md`, `component-table/reference.md`, `component-nav/reference.md`       |
...
- [`kit-core` skill](/acss-plugins-docs/acss-kit/skills/kit-core) — current orchestrator (successor to `components`)
- [`components` skill (legacy)](/acss-plugins-docs/acss-kit/skills/components) — v0.x–v1.1 reference
