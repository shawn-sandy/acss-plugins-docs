...
<Aside type="caution">
  ...
  skill](/acss-plugins-docs/acss-kit/skills/components) as **Form Mode**.
  Trigger it by saying "create a signup form with email and password" — the
  `components` skill handles form requests automatically. This page is preserved
  for reference.
</Aside>
