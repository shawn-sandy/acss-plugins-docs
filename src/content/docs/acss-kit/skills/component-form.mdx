...
<Aside type="note">
This is a **pilot skill** — it validates a per-component skill discovery pattern and may evolve. The generated output is stable; the natural language trigger vocabulary is what's being refined.
</Aside>
