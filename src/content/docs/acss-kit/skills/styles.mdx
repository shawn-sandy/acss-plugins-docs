...
<Aside type="note">
Values are stored in `oklch()` notation, not hex. This preserves the perceptual relationship between roles and allows the browser to interpolate them smoothly in animations and transitions.
</Aside>
