...
<Aside type="caution">
  Badge, Tag, Heading, Text/Paragraph, Details, and Progress exist only as
  inline entries in `kit-core/references/inline-components.md` and are **not**
  supported by `/kit-create` in v0.1. Promote them via the
  `/acss-kit-component-author` maintainer skill first.
</Aside>
