...
The generated palette covers all 18 semantic roles:
...
:root {
  ...
  /* Optional — set via DESIGN.md import or manual authoring */
  --color-surface-subtle: oklch(96% 0.006 270);
  --color-text-subtle: oklch(58% 0.012 270);
  --color-brand-accent: oklch(62% 0.18 210);
}
```
